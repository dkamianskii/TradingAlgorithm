...
from trading.trade_algorithms.predictive_trade_algorithms.ffn_trade_algorithm import FFNTradeAlgorithm
...
manager.plot_stock_history("WMT", img_dir="images", plot_algorithm_graph=True, show_full_stock_history=True)
