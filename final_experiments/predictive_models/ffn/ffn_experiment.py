...
from trading.trade_algorithms.predictive_trade_algorithms.ffn_trade_algorithm import FFNTradeAlgorithm, FFNTradeAlgorithmHyperparam
...
for i in range(eb.random_grid_search_attempts - 2):
    ...
    for company in eb.companies_names:
        manager.set_tracked_stock(company, eb.companies_data[company]["train data"], FFNTradeAlgorithm(), ffn_hyperparams_grid)
