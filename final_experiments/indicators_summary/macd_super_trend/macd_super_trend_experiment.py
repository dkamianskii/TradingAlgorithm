...
from trading.trade_algorithms.indicators_summary_trade_algorithms.macd_super_trend_trade_algorithm import MACDSuperTrendTradeAlgorithm
...
for i in range(eb.random_grid_search_attempts):
    ...
    for company in eb.companies_names:
        manager.set_tracked_stock(company, eb.companies_data[company]["train data"][-900:], MACDSuperTrendTradeAlgorithm())
